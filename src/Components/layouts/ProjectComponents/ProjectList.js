  ...
  const handleAddProject = async (newProject) => {
    try {
        ...
        if (today >= startDate && today <= endDate) {
            ...
            status = newProject.progress === 100 ? "Hoàn thành" : "Không hoàn thành";
        }
      ...
      .then((res) => {
          const updatedProjects = res.data.map(async (project) => {
              ...
              if (today >= startDate && today <= endDate) {
                  ...
                  status = project.progress === 100 ? "Hoàn thành" : "Không hoàn thành";
              }
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: 
                                          project.status === "Chưa bắt đầu"
                                              ? "gray"
                                              : project.status === "Đang thực hiện" || project.status === "Hoàn thành"
                                              ? "green"
                                              : "red"
                                    }}
                                >
